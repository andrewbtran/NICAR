...
Well, police argue that they patrol areas with high levels of crime, so if we get the latitude and longitude of every crime sorted by type, we can also compare that to the traffic stops and see if that squares up. 

There are so many more possible stories. And now you know how to get started.
